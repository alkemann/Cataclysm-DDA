...
class Creature
{
    public:
        ...
        const effect &get_effect_with_flag( const std::string &flag, body_part bp = num_bp ) const;
        int get_effect_mod_by_flag( const std::string &flag, body_part bp, const std::string &mod ) const;
